    ...
    <style>
        ...
        * {
        ...
        .agent-header {
            ...
            box-shadow: 0 2px 15px rgba(44, 52, 61, 0.035);
        }
        ...
        .agent-brand-icon {
            ...
            box-shadow: 0 5px 14px rgba(44, 52, 61, 0.14);
            position: relative;
            overflow: hidden;
        }
        ...
        .logout-button:hover {
            background: var(--cif-dark);
            color: #FFFFFF;
            border-color: var(--cif-dark);
            transform: translateY(-1px);
            box-shadow: 0 5px 14px rgba(44, 52, 61, 0.12);
        }
        ...
        .sidebar-link.active {
            background: var(--cif-dark);
            color: #FFFFFF;
            box-shadow: 0 7px 18px rgba(44, 52, 61, 0.16);
        }
        ...
        .sidebar-mini-card {
            min-height: 155px;
            border-radius: 18px;
            background: linear-gradient(145deg, var(--cif-dark) 0%, #39444F 100%);
            padding: 18px;
            position: relative;
            overflow: hidden;
            color: #FFFFFF;

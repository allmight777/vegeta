...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        /*
         * Overlay avec les couleurs d'origine :
         * gris foncé + jaune très léger.
         */
        .banner-overlay {
            position: absolute;
            inset: 0;
    ...
    <div class="app-body">
            ...
            <div class="banner-content">
                ...
                <div class="feature-list">
                    ...
                    <div class="feature-item">
                        ...
                        <span>
                            Validation biométrique haute précision
                        </span>
                    ...
                    <div class="feature-item">
                        ...
                        <span>
                            Accès strictement réservé aux agents accrédités
                        </span>
                    ...
                    <div class="feature-item">
                        ...
                        <span>
                            Synchronisation instantanée des présences
                        </span>
        ...
        <section class="form-section">
            ...
            <div class="form-card">
                ...
                <form
                    method="POST"
                    action="{{ route('agent.connexion.stocker') }}"
                    id="loginForm"
                >
                ...
                <div class="info-box">
                    ...
                    <p>
                        En cas d'oubli de matricule ou de blocage du terminal,

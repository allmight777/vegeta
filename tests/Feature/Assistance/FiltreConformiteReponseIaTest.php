...
class FiltreConformiteReponseIaTest extends TestCase
{
    ...
    public function test_une_reponse_piegee_n_atteint_jamais_le_caissier_et_est_journalisee(): void
    {
    ...
    public function test_la_meme_reponse_passe_intacte_pour_un_responsable_d_agence(): void
    {
    ...
    public function test_une_reponse_sans_mot_interdit_passe_intacte_pour_le_caissier(): void
    {
        $caissier = $this->agent(RoleAgent::Caissier);
